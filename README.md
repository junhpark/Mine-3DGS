...
| 0D Local GS baseline | **0D.1 resume safety contract: implemented + structurally tested** — gsplat v1.5.3 training resume 은 unsupported 이고 fail closed. **0D.2 real GPU baseline 미수행** → 0D 전체 **NOT COMPLETE** (ROADMAP §Phase 0D) |
